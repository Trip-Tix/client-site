                    ...
                    <Paper sx={{ padding: "1rem" }}>
                            ...
                            <Paper sx={{ padding: "1rem" }} elevation={3}>
                                ...
                                >
                                    <Stack direction={"column"} spacing={0}>
                                        <Typography variant={"body1"}>
                                            Temporary Ticket Means someone also
                                            booked the ticket
                                        </Typography>
                                        <Typography variant={"body1"}>
                                            You can not currently buy temporary
                                            booked tickets
                                        </Typography>
                                        <Typography variant={"body1"}>
                                            If the temporary booked tickets are
                                            somehow freed, You will be notified
                                        </Typography>
                                        <Typography variant={"body1"}>
                        ...
                        <TableContainer>
                            <Table sx={{ minWidth: 650 }}>
                                ...
                                <TableBody>
                                    {responseData.tempTicketInfo.map((row) => (
                                        <TableRow
                                            key={row.ticketId}
                                            sx={{
                                                "&:last-child td, &:last-child th":
